 ...
 */
define( 'PL_ADMIN'				, PL_PARENT_DIR		. '/admin'									);
 ...
 */
define( 'PL_SECTIONS'			, PL_PARENT_DIR . '/sections'									);
...
define( 'PL_EXTEND_INIT'		, PL_EXTEND_DIR . '/' . PL_EXTEND_SECTIONS_PLUGIN				);
 ...
 */
if ( is_dir( EXTEND_CHILD_DIR . '/language' ) )
	define( 'PAGELINES_LANGUAGE_DIR', EXTEND_CHILD_DIR . '/language' );
else
	define( 'PAGELINES_LANGUAGE_DIR', PL_PARENT_DIR . '/language' );
