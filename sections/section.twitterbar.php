				...
				<?php if(function_exists('twitter_messages') && pagelines('twittername')):?>
					<span class="twitter">
						<?php pagelines_register_hook( 'pagelines_before_twitterbar_text', $this->id ); // Hook ?>
						 "<?php twitter_messages(pagelines('twittername'), 1, false, false, '', false, false, false); ?>" &mdash;&nbsp;<a class="twitteraccount" href="http://www.twitter.com/<?php echo pagelines('twittername');?>"><?php echo ploption('twittername');?></a>
					</span>
				<?php else:?>
